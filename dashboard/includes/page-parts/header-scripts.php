...
<!-- Bootstrap-Switches -->
 ...
 <!-- bootstrap wysihtml5 - text editor -->
  ...
  <!-- Bootstrap-Switches -->
  <script src="<?php echo SITE_ROOT;  ?>assets/plugins/bootstrap-switch-master/dist/js/bootstrap-switch.min.js" type="text/javascript"></script>
    ...
    <!-- daterangepicker -->
        <script src="<?php echo SITE_ROOT;  ?>assets/plugins/daterangepicker/moment.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo SITE_ROOT;  ?>assets/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
        <!-- FLOT STACKED PLUGIN - Used to draw bar charts -->
    <script src="<?php echo SITE_ROOT;  ?>assets/plugins/flot/jquery.flot.stack.min.js" type="text/javascript"></script>
    <!-- CK Editor -->
    <script src="<?php echo SITE_ROOT;  ?>assets/plugins/ckeditor/ckeditor.js"></script>
        <!-- DATA TABES SCRIPT -->
 <script src="<?php echo SITE_ROOT;  ?>assets/plugins/DataTables/media/js/jquery.dataTables.min.js" type="text/javascript"></script> 
    <script src="<?php echo SITE_ROOT;  ?>assets/plugins/DataTables/extensions/bootstrap3/dataTables.bootstrap.js" type="text/javascript"></script>
	<script src="<?php echo SITE_ROOT;  ?>assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js" type="text/javascript"></script>
        <script src="<?php echo SITE_ROOT;  ?>assets/plugins/DataTables/extensions/TableTools/js/dataTables.tableTools.min.js" type="text/javascript"></script> 
