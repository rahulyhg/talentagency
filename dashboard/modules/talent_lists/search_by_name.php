...
$sql .= "( LOWER(first_name) LIKE '%".$query."%' ) ";
$sql .= "OR ( LOWER(last_name) LIKE '%".$query."%' ) ";
	...
	<div class="row">
		...
		<div class="box">
			<div class="box-header with-border">
              ...
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Please Enter a Name to Search</h3>
			    ...
			    <input type="text" class="serchform" name="query" placeholder="Enter Talent Name.." />
