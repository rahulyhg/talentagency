...
<!-- Documents Information box -->       			
		...
		?>	
 		...
 		<?php echo $doc_type; ?>
		 <a class="pull-right btn btn-default btn-xs" href="process_talent_deletes.php?action=delete_document&id=<?php echo $document['talent_document_id']; ?>&talent_id=<?php echo $talent_id; ?>"
